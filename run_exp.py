...
def main(rounds, seed, client_list, client_selection, CS_args, aggregation, Agg_args, client_train_config, client_test_config, batch_size):  
    ...
    total_minibatches_per_round = 100  # Total minibatches across all clients per round
    ...
    for rnd in range(1, rounds+1):
        ...
        # Distribute minibatches across selected clients
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        if exp_config is not None:
            ...
            # batch_sizes = [2**i for i in range(9, 12)]  # [1, 2, 4, 8, 16, 32, 64, 128, 256]
